# -*- coding: utf-8 -*-
#
# TOUCAN documentation build configuration file, created by
...
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__),'../../toucan')))
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__),'../../toucan/ingest_data')))
...
latex_documents = [
  ('index', 'toucan.tex', u'toucan Documentation',
   u'Jean-Gil Langlois', 'manual'),
]
...
man_pages = [
    ('index', 'toucan', u'toucan Documentation',
     [u'Jean-Gil Langlois'], 1)
]
...
texinfo_documents = [
  ('index', 'toucan', u'toucan Documentation',
   u'Jean-Gil Langlois', 'toucan', 'One line description of project.',
   'Miscellaneous'),
]
