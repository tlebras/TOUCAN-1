...
- inject_data : Directory containing the tools necessary to injest data into the database.
...
All the tools needed to injest data into the database are in the file injest.py
