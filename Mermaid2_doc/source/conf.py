# -*- coding: utf-8 -*-
#
# Mermaid2 documentation build configuration file, created by
...
latex_documents = [
  ('index', 'Mermaid2.tex', u'Mermaid2 Documentation',
...
man_pages = [
    ('index', 'Mermaid2', u'Mermaid2 Documentation',
...
texinfo_documents = [
  ('index', 'Mermaid2', u'Mermaid2 Documentation',
   u'Jean-Gil Langlois', 'Mermaid2', 'One line description of project.',
   'Miscellaneous'),
]
